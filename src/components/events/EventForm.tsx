...
const compactDateRowStyle = {
  display: "grid",
  gridTemplateColumns: "76px minmax(120px, 1fr) 64px",
  gap: 6,
  alignItems: "end" as const
};

const compactTimeRowStyle = {
  display: "grid",
