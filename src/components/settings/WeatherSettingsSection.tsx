        ...
        <div style={{ display: "grid", gap: 8 }}>
          {(project.weatherOverrides ?? []).map((o) => (
            <div key={o.id} style={{ border: "1px solid #374151", borderRadius: 6, padding: 8 }}>
              ...
              <label style={{ display: "block" }}><div style={{ fontSize: 12 }}>T</div><input type="number" value={o.temperature ?? ""} onChange={(e)=>onProjectUpdate(updateOverride(project,o.id,{temperature:e.target.value===""?undefined:Number(e.target.value)}))} style={inputStyle} /></label>
              <label style={{ display: "block" }}><div style={{ fontSize: 12 }}>Min/Max</div><div style={{ display:"flex", gap:6 }}><input type="number" value={o.dailyMinTemperature ?? ""} onChange={(e)=>onProjectUpdate(updateOverride(project,o.id,{dailyMinTemperature:e.target.value===""?undefined:Number(e.target.value)}))} style={inputStyle} /><input type="number" value={o.dailyMaxTemperature ?? ""} onChange={(e)=>onProjectUpdate(updateOverride(project,o.id,{dailyMaxTemperature:e.target.value===""?undefined:Number(e.target.value)}))} style={inputStyle} /></div></label>
              <label style={{ display: "block" }}><div style={{ fontSize: 12 }}>Rain / 24h</div><div style={{ display:"flex", gap:6 }}><input type="number" value={o.rain ?? ""} onChange={(e)=>onProjectUpdate(updateOverride(project,o.id,{rain:e.target.value===""?undefined:Number(e.target.value)}))} style={inputStyle} /><input type="number" value={o.dailyRainTotal ?? ""} onChange={(e)=>onProjectUpdate(updateOverride(project,o.id,{dailyRainTotal:e.target.value===""?undefined:Number(e.target.value)}))} style={inputStyle} /></div></label>
              <label style={{ display: "block" }}><div style={{ fontSize: 12 }}>Wind</div><input type="number" value={o.windSpeed ?? ""} onChange={(e)=>onProjectUpdate(updateOverride(project,o.id,{windSpeed:e.target.value===""?undefined:Number(e.target.value)}))} style={inputStyle} /></label>
              <label style={{ display: "block" }}><div style={{ fontSize: 12 }}>{t(project.locale, "weatherEvents.windDirection")}</div><select value={o.windDirection ?? ""} onChange={(e)=>onProjectUpdate(updateOverride(project,o.id,{windDirection:(e.target.value||undefined) as WindDirection|undefined}))} style={inputStyle}><option value="" />{windDirections.map(d=><option key={d} value={d}>{d}</option>)}</select></label>
