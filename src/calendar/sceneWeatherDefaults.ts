...
export const DEFAULT_SCENE_WEATHER_PROFILES: SceneWeatherProfile[] = [
  ...
  { id: "snowstorm", name: "Tempête de neige", icon: "🌨️", enabled: true, durationMinutes: 120, transitionMinutes: 10, override: { state: "blizzard", dominantState: "blizzard", trendKind: "stormy", temperature: -8, dailyMinTemperature: -14, dailyMaxTemperature: -3, rain: 2.2, dailyRainTotal: 25, windSpeed: 45 } },
  ...
  { id: "simple-monsoon", name: "Mousson simple", icon: "🌧️", enabled: true, durationMinutes: 240, transitionMinutes: 15, forceBiomeId: "jungle", override: { state: "monsoon", dominantState: "monsoon", trendKind: "wet", temperature: 26, dailyMinTemperature: 23, dailyMaxTemperature: 29, rain: 6, dailyRainTotal: 70, windSpeed: 22 } },
  ...
  { id: "sea-fog", name: "Brume marine", icon: "🌫️", enabled: true, durationMinutes: 240, transitionMinutes: 15, forceBiomeId: "coast", override: { state: "seaFog", dominantState: "seaFog", trendKind: "wet", temperature: 12, dailyMinTemperature: 9, dailyMaxTemperature: 15, rain: 0.2, dailyRainTotal: 2, windSpeed: 6 } },
  { id: "volcanic-ash", name: "Cendres volcaniques", icon: "🌋", enabled: true, durationMinutes: 240, transitionMinutes: 20, forceBiomeId: "volcanic", override: { state: "volcanicAsh", dominantState: "volcanicAsh", trendKind: "dry", temperature: 25, dailyMinTemperature: 20, dailyMaxTemperature: 31, rain: 0, dailyRainTotal: 0, windSpeed: 12 } },
