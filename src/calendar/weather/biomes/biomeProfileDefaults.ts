...
export const DEFAULT_WEATHER_BIOME_PROFILES: Record<WeatherBiomeId, WeatherBiomeProfile> = {
  ...
  mountain: {
    ...
    stateWeights: { strongWind: 1.4, snow: 1.3, fog: 1.2, clear: 0.9 }
  },
  arctic: {
    ...
    stateWeights: { snow: 2.5, strongWind: 1.5, tempest: 1.2, clear: 0.8, lightRain: 0.2, heavyRain: 0.1 }
  },
  desert: {
    ...
    stateWeights: { clear: 1.8, cloudy: 0.6, overcast: 0.4, lightRain: 0.2, heavyRain: 0.05, storm: 0.4, strongWind: 1.3 }
  },
  marsh: {
    ...
    stateWeights: { fog: 1.8, lightRain: 1.5, heavyRain: 1.3, overcast: 1.4, clear: 0.7 }
  },
  jungle: {
    ...
    stateWeights: { lightRain: 1.5, heavyRain: 1.8, storm: 1.4, fog: 1.3, clear: 0.7 }
  },
  temperateForest: {
  ...
  coast: {
    ...
    stateWeights: { strongWind: 1.4, fog: 1.2, lightRain: 1.2, storm: 1.1 }
  },
  freshwater: {
  ...
  sea: {
    ...
    stateWeights: { strongWind: 1.8, tempest: 1.4, storm: 1.4, heavyRain: 1.4, fog: 1.2, clear: 0.7 }
  },
  hell: {
    ...
    stateWeights: { clear: 1.4, storm: 1.3, tempest: 1.2, lightRain: 0.05, heavyRain: 0.02, snow: 0.01, fog: 0.6 }
  },
  volcanic: {
    ...
    stateWeights: { overcast: 1.5, fog: 1.4, strongWind: 1.2, clear: 0.8, snow: 0.1 }
  },
  sky: {
    ...
    stateWeights: { strongWind: 2, tempest: 1.5, clear: 1.1, fog: 0.7 }
  },
  paradise: {
